// rrt.h : This file contains the 'main' function. Program execution begins and ends there.
//

#ifndef RRT_H_IS_INCLUDED
#define RRT_H_IS_INCLUDED
...
public:
    ...
    std::vector<CSpaceVertex> plannerRRT(
        double* map,
        int x_size,
        int y_size,
        CSpaceVertex start,
